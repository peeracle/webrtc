...

{
  ...
  'inputs': [
    ...
    '<(webrtc_depth)/build/android/gyp/pack_relocations.py',
  ...
  'conditions': [
    ['enable_packing == 1', {
      ...
      'dependencies': [
        '<(webrtc_depth)/third_party/android_platform/relocation_packer.gyp:android_relocation_packer#host',
      ],
      'inputs': [
        '<(PRODUCT_DIR)/android_relocation_packer',
      ],
      'action': [
        'python', '<(webrtc_depth)/build/android/gyp/pack_relocations.py',
