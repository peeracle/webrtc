...

{
  ...
  'inputs': [
    '<(webrtc_depth)/build/android/gyp/emma_instr.py',
    '<(webrtc_depth)/build/android/gyp/util/build_utils.py',
    '<(webrtc_depth)/build/android/pylib/utils/command_option_parser.py',
  ],
  'action': [
    'python', '<(webrtc_depth)/build/android/gyp/emma_instr.py',
    '<(instr_action)',
