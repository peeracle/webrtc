              ...
              ['_type=="executable"', {
                'variables': {
                  ...
                  'ios_unittest_info_plist_path':
                    '<(webrtc_depth)/testing/gtest_ios/unittest-Info.plist',
                },
                'mac_bundle': 1,
                'xcode_settings': {
                  'BUNDLE_ID_TEST_NAME':
                ...
                'mac_bundle_resources': [
                  '<(ios_unittest_info_plist_path)',
                  '<(webrtc_depth)/testing/gtest_ios/Default.png',
                ],
                'mac_bundle_resources!': [
                  '<(ios_unittest_info_plist_path)',
                ],
                ...
                'postbuilds': [
                  {
                    'variables': {
                      ...
                      'copy_asan_dylib_path':
                        '<(webrtc_depth)/build/mac/copy_asan_runtime_dylib.sh',
                    },
              ...
              ['OS=="ios"', {
                'variables': {
                  ...
                  'ios_run_unittest_script_path':
                    '<(webrtc_depth)/testing/gtest_ios/run-unittest.sh',
                },
                'run_as': {
