...
{
  'variables': {
    'protoc_wrapper': '<(webrtc_depth)/tools/protoc_wrapper/protoc_wrapper.py',
  ...
  'dependencies': [
    '<(webrtc_depth)/third_party/protobuf/protobuf.gyp:protoc#host',
    '<(webrtc_depth)/third_party/protobuf/protobuf.gyp:protobuf_lite',
  ],
  'include_dirs': [
